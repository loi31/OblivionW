-- modified ova.rocks
_G.menukey = "RightShift"
local library = {}
function library:New(name)
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/loi31/OblivionW/main/Signal"))()
...
local cfglocation = "oblivionpro/dahood"


local Vec2 = Vector2.new
local Vec3 = Vector3.newv
local CF = CFrame.new
...
function library:SaveConfig(cfg)
	local copy = library:deepCopy(values)
	for i,Tabs in pairs(copy) do
		for i,Sectors in pairs(Tabs) do
			for i,Elements in pairs(Sectors) do
				if Elements.Color ~= nil then
...
function library:SaveOnlineConfig(cfg,name)
    local copy = library:OnlineDeepCopy(cfg)
    for i,Tabs in pairs(copy) do
		for i,Sectors in pairs(Tabs) do
			for i,Elements in pairs(Sectors) do
				if Elements.Color ~= nil then
    ...
    writefile(cfglocation..name..".txt", game:GetService("HttpService"):JSONEncode(copy))
end
	...
	do
		...
		TextLabel.BackgroundColor3 = COL3RGB(16, 16, 16)
		TextLabel.BorderColor3 = COL3RGB(119, 0, 255)
	...
	function menu:Tab(text)
		...
		TabGui.Image = "rbxassetid://5553946656"
		...
		Left.ScrollBarImageColor3 = Color3.fromRGB(119, 0, 255)
		...
		Right.ScrollBarImageColor3 = Color3.fromRGB(119, 0, 255)
